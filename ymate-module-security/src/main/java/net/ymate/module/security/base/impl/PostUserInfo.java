...
import net.ymate.module.security.base.IPostUserInfo;
 ...
 * @since 1.0.0
 */
public class PostUserInfo extends AbstractAttributeExt implements IPostUserInfo {
    ...
    public static class Builder extends AbstractBuilder<Builder, PostUserInfo> {

        public Builder() {
            super(new PostUserInfo());
        }

        public Builder(PostUserInfo target) {
            super(target);
        }
