...
import net.ymate.module.security.base.IGroupRoleInfo;
 ...
 * @since 1.0.0
 */
public class GroupRoleInfo extends AbstractAttributeExt implements IGroupRoleInfo {
    ...
    public static class Builder extends AbstractBuilder<Builder, GroupRoleInfo> {

        public Builder() {
            super(new GroupRoleInfo());
        }

        public Builder(GroupRoleInfo target) {
            super(target);
        }
